  ...
  useGSAP(
    () => {
      ...
      tl.to(".ld-header .reveal-fade", {
        ...
        .set(".ld-header .reveal-fade", { filter: "none" })
        .to(
          ".ld-card",
        ...
        {big.map((ep, i) => (
          ...
          >
            <div className="ld-thumb-wrap relative aspect-video overflow-hidden will-change-transform">
              ...
              >
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-ink/85">
                  <svg viewBox="0 0 16 16" className="ml-0.5 h-4 w-4 fill-mango" aria-hidden>
                    <path d="M4 2.5v11l10-5.5-10-5.5z" />
                  </svg>
                </span>
              </span>
              <span className="absolute bottom-2.5 right-2.5 rounded-md bg-ink px-2 py-1 font-sans text-xs font-extrabold text-mango">
                {ep.duration}
              </span>
            </div>
            <div className="p-4 pb-5">
              ...
              <div className="mb-2 font-sans text-[17px] font-extrabold leading-[1.24] text-ink">
                {ep.title}
              </div>
              <div className="font-sans text-[13px] font-semibold text-ink/55">{ep.guest}</div>
            </div>
          </a>
        ))}
      </div>
